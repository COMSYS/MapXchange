...
def add_colored_formatter(
    ...
    """Add ColoredFormatter to a given logger or to root logger."""
...
def add_filehandler(file: str,
    ...
    """Add filehandler for given file to a given logger or to root logger."""
...
def configure_root_logger(logging_level: int,
                         file: str | None = None) -> logging.Logger:
    """Add both colored formatter and filehandler to root logger."""
